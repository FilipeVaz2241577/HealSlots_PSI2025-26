<?php
// console/commands/RbacController.php
...
class RbacController extends Controller
{
    public function actionInit()
    {
        ...
        echo "Roles criadas conforme tabela:\n";
        echo "- Admin: Back-Office + Front-Office\n";
        echo "- TecnicoSaude: Front-Office\n";
        echo "- AssistenteManutencao: Back-Office\n";
    }
}
